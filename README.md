...
기존의 Sprint Security는 WebSecurityConfigurerAdapter를 사용했었는데. 이는 클래스에서 메서드를 오버라이드하여 보안을 구성하는 방법이었다.<br />
...
<br />
확실한 것은 기존의 WebSecurityConfigurerAdapter를 상속받아 한곳에 다 때려박혀야 했던 코드들을 컴포넌트 방식으로 분할하였고.<br />
